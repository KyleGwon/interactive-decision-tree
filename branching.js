...
/*
	...
	d3.select(this)
		...
		.transition().ease(d3.easeCubic).duration(mouseoverTime).attr('r', (d)=>{
			if (d.children==undefined) {
				return smallRadius
			}
			return largeRadius
	...
	.on('mouseout', function(d){
		d3.select(this)
			...
			.transition().ease(d3.easeCubic).duration(mouseoverTime).attr('r', smallRadius)
